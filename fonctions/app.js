...
function jeVerseDansMaBouteille(nbCl, typeBouteille) {
    // console.log("Je verse dans ma bouteille: " + nbCl + "cl");
    console.log(`Je verse dans ma bouteille ${typeBouteille}: ${nbCl} cl`);
    console.log("Glouglou.....");
    console.log("Oh non un peu de contenu s'écoule!")
...
console.log(contenuBouteilleCoca);
